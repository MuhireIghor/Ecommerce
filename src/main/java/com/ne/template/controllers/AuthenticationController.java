...
import com.ne.template.security.JwtTokenProvider;
import com.ne.template.security.UserPrincipal;
import com.ne.template.serviceImpls.EmailService;
...
import com.ne.template.utils.JWTAuthenticationResponse;
import com.ne.template.utils.UserUtils;
...
public class AuthenticationController {
    ...
    @Autowired
    public AuthenticationController(IAuthenticationService authenticationService, JwtTokenProvider jwtTokenProvider, AuthenticationManager authenticationManager, UserServiceImpl userService, EmailService emailService, AuthenticationProvider authenticationProvider) {
    ...
    public ResponseEntity<ApiResponse> handleLogin(@RequestBody @Valid SignInDto request) {
        String jwt = null;
        User user = null;
